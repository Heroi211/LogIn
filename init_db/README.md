...
- Permissões seed: ver `docs/FUNCTIONALITY_CATALOG.md`
...
Edite `database.sql` (papéis, admin, permissões, dados de exemplo).  
Atualize também `docs/FUNCTIONALITY_CATALOG.md` ao alterar o catálogo.  
